...
//			$item['name'] = $this->itemname[$tmp_item];
      $item['options'] = $this->itemnames[$tmp_item];
      $item['name'] = $item['options']['item-name'];
//JSTN-end
	...
	function add_item($item_id, $item_qty=1, $item_price, $item_name)
		...
		if ($valid_item_qty !== false && $valid_item_price !== false)
			...
			if (($this->itemqtys[$item_id] > 0) && ($this->itemnames[$item_id] === $item_name))
				{
...
//			$item_added = $this->add_item($item_id, $item_qty, $item_price, $item_name);
      ...
      $item_added = $this->add_item($item_id, $item_qty, $item_price, $options);
//JSTN-end
...
echo print_r($this->itemqtys);
echo print_r($this->itemprices);
echo print_r($this->itemnames);
//echo print_r($this->itemname['id3-hockey-stick']['0']);
echo "</pre>";
